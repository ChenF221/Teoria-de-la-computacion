...
def main():
    ...
    player1 = nfa_find_all_paths(cadena, 1) # Start from state 1
    player2 = nfa_find_all_paths(cadena, 3)
    

    write_paths_to_file(player1, all_routes_player1)
    write_paths_to_file(player2, all_routes_player2)
    verify_routes(all_routes_player1, win_routes_player1, 9)
    verify_routes(all_routes_player2, win_routes_player2, 7)
